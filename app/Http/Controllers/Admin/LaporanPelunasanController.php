...
class LaporanPelunasanController extends Controller
{
    public function index(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan pembelian ban']) {
            ...
            $inquery = Pelunasan::orderBy('id', 'DESC');
            ...
            return view('admin.laporanpelunasan.index', compact('inquery'));
        // } else {
    ...
    public function print_laporanpelunasan(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan pembelian ban']) {
            ...
            $query = Pelunasan::orderBy('id', 'DESC');
            ...
            $pdf = PDF::loadView('admin.laporanpelunasan.print', compact('inquery'));
