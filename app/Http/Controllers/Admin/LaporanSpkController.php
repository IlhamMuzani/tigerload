...
class LaporanSpkController extends Controller
{
    public function index(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan pembelian ban']) {
            ...
            return view('admin.laporanspk.index', compact('inquery'));
        // } else {
    ...
    public function print_laporanspk(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan pembelian ban']) {
            ...
            $pdf = PDF::loadView('admin.laporanspk.print', compact('inquery'));
