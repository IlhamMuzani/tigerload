...
class LaporanDepositController extends Controller
{
    public function index(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan pembelian ban']) {
            ...
            $inquery = Depositpemesanan::orderBy('id', 'DESC');
            ...
            return view('admin.laporandeposit.index', compact('inquery'));
        // } else {
    ...
    public function print_laporandeposit(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan pembelian ban']) {
            ...
            $query = Depositpemesanan::orderBy('id', 'DESC');
            ...
            $pdf = PDF::loadView('admin.laporandeposit.print', compact('inquery'));
