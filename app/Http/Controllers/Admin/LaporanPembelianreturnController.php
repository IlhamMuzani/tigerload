...
class LaporanPembelianreturnController extends Controller
{
    public function index(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan pembelian ban']) {
            ...
            $inquery = Returnpembelian::orderBy('id', 'DESC');
            ...
            return view('admin.laporanpembelianreturn.index', compact('inquery'));
        // } else {
    ...
    public function print_laporanpembelianreturn(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan pembelian ban']) {
            ...
            $query = Returnpembelian::orderBy('id', 'DESC');
            ...
            $pdf = PDF::loadView('admin.laporanpembelianreturn.print', compact('inquery'));
