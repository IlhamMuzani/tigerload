...
class LaporanPengambilanbahanController extends Controller
{
    public function index(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan pembelian ban']) {
            ...
            return view('admin.laporanpengambilanbahan.index', compact('inquery'));
        // } else {
    ...
    public function print_laporanpengambilanbahan(Request $request)
    {
        // if (auth()->check() && auth()->user()->menu['laporan pembelian ban']) {
            ...
            $pdf = PDF::loadView('admin.laporanpengambilanbahan.print', compact('inquery'));
