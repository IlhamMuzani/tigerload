    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <form action="{{ url('pelanggan/profile/update') }}" method="post" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama_lengkap" readonly
                                placeholder="" value="{{ old('nama', $user->pelanggan->nama_pelanggan ?? null) }}">
                        </div>
                        <div class="form-group">
                            <label for="kode">Kode User</label>
                            <input type="text" class="form-control" id="kode_user" name="kode_user" readonly
                                placeholder="" value="{{ old('kode_user', $user->kode_user) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="telp" name="telp" class="form-control" readonly
                                    placeholder="" value="{{ old('telp', $user->pelanggan->telp ?? null) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="alamat">Alamat</label>
                            <textarea class="form-control" id="alamat" name="alamat" readonly rows="3" placeholder="Masukan alamat">{{ old('alamat', $user->pelanggan->alamat ?? null) }}</textarea>
                        </div>
                        {{-- <div class="form-group">
