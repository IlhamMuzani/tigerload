...
@section('title', 'Inquery Return Pembelian')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Return Pembelian</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Inquery Return Pembelian</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Inquery Return Pembelian</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_pembelianreturn/unpostpembelianreturn/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_pembelianreturn/postingpembelianreturn/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
