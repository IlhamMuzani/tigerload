...
@section('title', 'Inquery Perintah Kerja')
...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Inquery Perintah Kerja</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($surat->status == 'unpost')
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ url('admin/inquery_perintahkerja/' . $surat->id . '/edit') }}">Update</a>

                                                <a class="dropdown-item"
                                                    href="{{ url('admin/inquery_perintahkerja/' . $surat->id) }}">Show</a>

                                                <form style="margin-top:5px" method="GET"
                                                    action="{{ route('hapusperintahkerja', ['id' => $surat->id]) }}">
                                                    <button type="submit"
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/inquery_perintahkerja') }}";
            form.submit();
        }
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_perintahkerja/unpostperintahkerja/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_perintahkerja/postingperintahkerja/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
