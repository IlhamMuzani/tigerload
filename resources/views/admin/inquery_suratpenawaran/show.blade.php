...
<body style="margin: 0; padding: 0;">
    ...
    <table width="100%">
        <tr>
            <td>
                <div class="info-container">
                    ...
                    <div style="display: flex; justify-content: center; align-items: center;">
                        <table style="text-align: center;">
                            ...
                            <tr>
                                <td style="font-size: 25px; font-weight: lighter;">No. Izin Karoseri : 400.7.22/ 11428</td>
                            </tr>
                ...
                <div style="margin-left: 70px; font-size: 22px;">
                    <table>
                        <tr>
                            <td>
        ...
        @if ($pembelians->kategori == 'PPN')
            ...
            <tr style="font-weight: bold">
                ...
                <td style="font-weight: bold; font-size:22px">Rp.
    ...
    <div class="container">
        <a href="{{ url('admin/inquery_penawaran') }}" class="blue-button">Kembali</a>
