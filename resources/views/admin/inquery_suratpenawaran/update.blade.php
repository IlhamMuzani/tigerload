...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Surat Penawaran Karoseri</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/inquery_penawaran') }}">Surat Penawaran
                                Karoseri</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- /.card-header -->
            <form action="{{ url('admin/inquery_penawaran/' . $pembelian->id) }}" method="POST"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="aksesoris" placeholder="" name="aksesoris"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="jumlah_unit" name="jumlah_unit">
                                <option value="">- Pilih -</option>
                                <option value="1"
                                    {{ old('jumlah_unit', $pembelian->jumlah_unit) == '1' ? 'selected' : null }}>
                                    1 Unit</option>
                                <option value="2"
                                    {{ old('jumlah_unit', $pembelian->jumlah_unit) == '2' ? 'selected' : null }}>
                                    2 Unit</option>
                                <option value="3"
                                    {{ old('jumlah_unit', $pembelian->jumlah_unit) == '3' ? 'selected' : null }}>
                                    3 Unit</option>
                                <option value="4"
                                    {{ old('jumlah_unit', $pembelian->jumlah_unit) == '4' ? 'selected' : null }}>
                                    4 Unit</option>
                                <option value="5"
                                    {{ old('jumlah_unit', $pembelian->jumlah_unit) == '5' ? 'selected' : null }}>
                                    5 Unit</option>
                                <option value="6"
                                    {{ old('jumlah_unit', $pembelian->jumlah_unit) == '6' ? 'selected' : null }}>
                                    6 Unit</option>
                                <option value="7"
                                    {{ old('jumlah_unit', $pembelian->jumlah_unit) == '7' ? 'selected' : null }}>
                                    7 Unit</option>
                                <option value="8"
                                    {{ old('jumlah_unit', $pembelian->jumlah_unit) == '8' ? 'selected' : null }}>
                                    8 Unit</option>
                                <option value="9"
                                    {{ old('jumlah_unit', $pembelian->jumlah_unit) == '9' ? 'selected' : null }}>
                                    9 Unit</option>
                                <option value="10"
                                    {{ old('jumlah_unit', $pembelian->jumlah_unit) == '10' ? 'selected' : null }}>
                                    10 Unit</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <input type="text" class="form-control" id="harga" name="harga" placeholder=""
                            value="{{ number_format(old('harga', $pembelian->harga), 0, ',', '.') }}" oninput="formatRupiahform(this)"
