                            ...
                            @foreach ($inquery as $pembelian)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($pembelian->status == 'unpost')
                                            <a href="{{ url('admin/inquery_penawaran/' . $pembelian->id) }}"
                                                class="btn btn-info btn-sm">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ url('admin/inquery_penawaran/' . $pembelian->id . '/edit') }}"
                                                class="btn btn-info btn-sm">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Unpost Penawaran</h4>
                                            ...
                                            <div class="modal-body">
                                                <p>Unpost Surat Penawaran Karoseri
                                            ...
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <a class="btn btn-primary"
                                                    href="{{ route('unpostpenawaran', ['id' => $pembelian->id]) }}">Ya</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade" id="modal-posting-{{ $pembelian->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Posting Surat Penawaran Karoseri</h4>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            ...
                                            <div class="modal-body">
                                                <p>Posting Surat Penawaran Karoseri
                                            ...
                                            <div class="modal-footer justify-content-between">
                                                <button type="button" class="btn btn-default"
                                                    data-dismiss="modal">Batal</button>
                                                <a class="btn btn-primary"
                                                    href="{{ route('postingpenawaran', ['id' => $pembelian->id]) }}">Ya</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade" id="modal-hapus-{{ $pembelian->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Hapus Surat Penawaran Karoseri</h4>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            ...
                                            <div class="modal-body">
                                                <p>Yakin hapus Surat Penawaran Karoseri <strong>{{ $pembelian->kode_pembelian }}</strong>?
                                                </p>
                                            </div>
                                            <div class="modal-footer justify-content-between">
                                                <button type="button" class="btn btn-default"
                                                    data-dismiss="modal">Batal</button>
                                                <form action="{{ url('admin/inquery_penawaran/' . $pembelian->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                            ...
                                            <div class="modal-body">
                                                <div style="text-align: center;">
                                                    <div style="display: inline-block;">
                                                        {!! DNS2D::getBarcodeHTML("$pembelian->qrcode_penawaran", 'QRCODE', 15, 15) !!}
                                                    </div>
                                                </div>
                                                <div class="modal-footer justify-content-between">
                                                    <button type="button" class="btn btn-default"
