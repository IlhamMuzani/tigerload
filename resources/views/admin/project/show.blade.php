...
<body>
                ...
                <div class="container-fluid ">
                    <div class="contact_nav">
                        <a href="">
                            ...
                            <span>
                                CV. TIGER LOAD ENGINEERING (+62 00000)
                            </span>
                        </a>
            ...
            <div class="container ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="{{ asset('qrcode/images/s2.png') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Cargo Transport
                    ...
                    <div class="col-md-6 ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="{{ asset('qrcode/images/s3.png') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Trucks Transport
                    ...
                    <div class="col-md-6 ">
                        <div class="box ">
                            <div class="{{ asset('qrcode/img-box') }}">
    ...
    <section class="about_section layout_padding-bottom">
        <div class="container  ">
            <div class="row">
                ...
                <div class="col-md-6 ">
                    <div class="img-box">
                        <img src="{{ asset('qrcode/images/about-img.jpg') }}" alt="">
                    </div>
                </div>
    ...
    <section class="track_section layout_padding">
        <div class="track_bg_box">
            <img src="{{ asset('qrcode/images/track-bg.jpg') }}" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="owl-carousel">
                        <div class="item">
                            <div class="box">
                                ...
                                <div class="client_id">
                                    <div class="img-box">
                                        <img src="{{ asset('qrcode/images/client-1.png') }}" alt=""
                                            class="img-1">
                                    </div>
                                    <div class="name">
                                        <h6>
                        ...
                        <div class="item">
                            <div class="box">
                                ...
                                <div class="client_id">
                                    <div class="img-box">
                                        <img src="{{ asset('qrcode/images/client-2.png') }}" alt=""
                                            class="img-1">
                                    </div>
                                    <div class="name">
                                        <h6>
                ...
                <div class="col-md-6 col-lg-2 mx-auto info_col">
                    <div class="info_link_box">
                        ...
                        <div class="info_links">
                            <a class="active" href="{{ asset('qrcode/index.html') }}">
                                <img src="{{ asset('qrcode/images/nav-bullet.png') }}" alt="">
                                Home
                            </a>
                            <a class="" href="{{ asset('qrcode/about.html') }}">
                                <img src="{{ asset('qrcode/images/nav-bullet.png') }}" alt="">
                                About
                            </a>
                            <a class="" href="{{ asset('qrcode/service.html') }}">
                                <img src="{{ asset('qrcode/images/nav-bullet.png') }}" alt="">
                                Services
                            </a>
                            <a class="" href="{{ asset('qrcode/contact.html') }}">
                                <img src="{{ asset('qrcode/images/nav-bullet.png') }}" alt="">
                                Contact Us
                            </a>
                        </div>
