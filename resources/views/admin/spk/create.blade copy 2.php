...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('model') is-invalid @enderror" id="model"
                                name="model" readonly type="text" placeholder="" value="{{ old('model') }}" />
                        </div>
                        <div class="mb-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sasis" name="sasis" readonly
                                placeholder="" value="{{ old('sasis') }}">
                        </div>
                        <div class="form-group">
                            <label for="cros_member">Cross Member</label>
                            <input type="text" class="form-control" id="cros_member" name="cros_member" readonly
                                placeholder="" value="{{ old('cros_member') }}">
                        </div>
                        <div class="form-group">
                            <label for="fream_samping">Frame Samping</label>
                            <input type="text" class="form-control" id="fream_samping" name="fream_samping" readonly
                                placeholder="" value="{{ old('fream_samping') }}">
                        </div>
                        <div class="form-group">
                            <label for="diafragma">Diafragma</label>
                            <input type="text" class="form-control" id="diafragma" name="diafragma" readonly
                                placeholder="" value="{{ old('diafragma') }}">
                        </div>
                        <div class="form-group">
                            <label for="dinding">Plat Dinding</label>
                            <input type="text" class="form-control" id="dinding" name="dinding" readonly
                                placeholder="" value="{{ old('dinding') }}">
                        </div>

                        <div class="form-group">
                            <label for="lantai">Plat Lantai</label>
                            <input type="text" class="form-control" id="lantai" name="lantai" readonly
                                placeholder="" value="{{ old('lantai') }}">
                        </div>

                        <div class="form-group">
                            <label for="warna_dalam"> Warna Dalam</label>
                            <input type="text" class="form-control" id="warna_dalam" name="warna_dalam" placeholder=""
                                value="{{ old('warna_dalam') }}">
                        </div>
                        <div class="form-group">
                            <label for="warna_luar"> Warna Luar</label>
                            <input type="text" class="form-control" id="warna_luar" name="warna_luar" placeholder=""
                                value="{{ old('warna_luar') }}">
                        </div>
                         <div class="form-group">
                            <label for="warna_luar"> Aksesoris</label>
                            <input type="text" class="form-control" id="warna_luar" name="warna_luar" placeholder=""
                                value="{{ old('warna_luar') }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('harga') is-invalid @enderror" id="harga"
                                name="harga" type="text" placeholder="masukan harga"
                                value="{{ old('harga') }}" />
                        </div>
                ...
                <form action="{{ url('admin/karoseris') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sasis"
                                placeholder="Masukan sasis" value="{{ old('sasis') }}">
                        </div>
                        <div class="form-group">
                            <label for="cros_member">Cross Member</label>
                        ...
                        <div class="form-group">
                            <label for="diafragma">Diafragma</label>
                            <input type="text" class="form-control"  name="diafragma"
                            ...
                            <tbody>
                                @foreach ($typekaroseris as $typekaroseri)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-primary btn-sm"
                                                onclick="getSelectedDatakaroseri('{{ $typekaroseri->id }}', '{{ $typekaroseri->kode_type }}', '{{ $typekaroseri->nama_karoseri }}', '{{ $typekaroseri->panjang }}', '{{ $typekaroseri->lebar }}', '{{ $typekaroseri->tinggi }}', '{{ $typekaroseri->sasis }}', '{{ $typekaroseri->cros_member }}', '{{ $typekaroseri->fream_samping }}', '{{ $typekaroseri->diafragma }}', '{{ $typekaroseri->lantai }}', '{{ $typekaroseri->dinding }}')">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </td>
                                    </tr>
    ...
    <script>
        ...
        function getSelectedDatakaroseri(karoseri_id, kodeKaroseri, namaKaroseri, Panjang, Lebar, Tinggi,
