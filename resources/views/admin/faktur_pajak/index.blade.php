...
@section('title', 'Faktur Pajak Penjualan')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Faktur Pajak Penjualan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Faktur Pajak Penjualan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Faktur Pajak Penjualan</h3>
                    <div class="float-right">
                        <a href="{{ url('admin/faktur_pajak/create') }}" class="btn btn-primary btn-sm">
                        ...
                        <tbody class="list">
                            @foreach ($inquery as $faktur_pajak)
                                <tr class="dropdown"{{ $faktur_pajak->id }}>
                                    ...
                                    <td>
                                        @if ($faktur_pajak->penjualan)
                                            {{ $faktur_pajak->penjualan->kode_penjualan }}
                                        @else
                                            tidak ada
                                        @endif
                                    </td>
                                    <td>
                                        @if ($faktur_pajak->penjualan)
                                            @if ($faktur_pajak->penjualan->perintah_kerja)
                                                {{ $faktur_pajak->penjualan->perintah_kerja->pelanggan->nama_pelanggan }}
                                            @else
                                            @endif
                                        @else
                                            tidak ada
                                    ...
                                    <td>
                                        {{ $faktur_pajak->tanggal_awal }}
                                    </td>
                                    <td>
                                        @if ($faktur_pajak->penjualan == null)
                                        @else
                                            @if ($faktur_pajak->penjualan->perintah_kerja->spk)
                                                Rp
                                                {{ number_format($faktur_pajak->penjualan->perintah_kerja->spk->harga, 0, ',', '.') }}
                                            @else
                                            @endif
                                        @endif
                                    ...
                                    $total_price = $faktur_pajak->penjualan->perintah_kerja->spk->harga ?? 0;
                                    $tax_rate = 0.11;
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($faktur_pajak->status == 'unpost')
                                                <a class="dropdown-item posting-btn"
                                                    data-memo-id="{{ $faktur_pajak->id }}">Posting</a>
