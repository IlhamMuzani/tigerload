...
<body style="margin: 0; padding: 0;">
    ...
    <table cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td style="text-align: left;">
                <span class="content2">
                    {{ $cetakpdf->penjualan->perintah_kerja->spk->pelanggan->nama_pelanggan }}
                </span>
                <br>
            </td>
        </tr>
        <tr>
            ...
            <td style="text-align: left; ">
                <span class="content2">
                    {{ $cetakpdf->penjualan->perintah_kerja->spk->pelanggan->alamat }} </span>
                <br>
            </td>
        </tr>
        <tr>
            ...
            <td style="text-align: left; ">
                <span class="content2">
                    {{ $cetakpdf->penjualan->perintah_kerja->spk->pelanggan->telp }}
                </span>
                <br>
            </td>
        </tr>
        <tr>
            ...
            <td style="text-align: left; ">
                <span class="content2">
                    {{ $cetakpdf->penjualan->perintah_kerja->spk->pelanggan->kode_pelanggan }} </span>
                <br>
            </td>
        </tr>
    </table>
    ...
    <table style="font-size:13px" width="100%">
        <tr>
            <td>
                <span class="info-item">No. Faktur: {{ $cetakpdf->penjualan->kode_deposit }}</span>
                <br>
            </td>
            <td style="text-align: right;">
                {{-- <span class="info-item">Tanggal:{{ now()->format('d-m-Y') }}</span> --}}
                <span class="info-item">Tanggal:{{ $cetakpdf->penjualan->tanggal }}</span>
                <br>
            </td>
        </tr>
    </table>
