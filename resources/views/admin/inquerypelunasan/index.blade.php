                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($pelunasan->status == 'unpost')
                                            <a href="{{ url('admin/inquery_pelunasan/' . $pelunasan->id) }}"
                                                class="btn btn-info btn-sm">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ url('admin/inquery_pelunasan/' . $pelunasan->id . '/edit') }}"
                                                class="btn btn-info btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#modal-hapus-{{ $pelunasan->id }}">
                                                <i class="fas fa-times"></i>
                                            </button>
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                                data-target="#modal-posting-{{ $pelunasan->id }}">
                                        ...
                                        @if ($pelunasan->status == 'posting')
                                            ...
                                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                                                data-target="#modal-unpost-{{ $pelunasan->id }}">
                                                <i class="fas fa-check"></i>
                                            </button>
                                        @endif
                                    </td>
