...
<body style="margin: 0; padding: 0;">
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: left; paddin 5px; font-size: 13px;">Nama Produk</td>
        ...
        <tr>
            <td>
                <span class="info-item"
                    style="font-size: 13px; padding-left: 5px;">-{{ $pelunasans->kategori }}({{ $pelunasans->nomor }})=({{ number_format($pelunasans->nominal, 0, ',', '.') }})({{ $pelunasans->tanggal_transfer }})
                </span>
                <br>
            </td>
        </tr>
