        ...
        <tr>
            ...
            <td style="width: 50%;">
                <div class="info-catatan">
                    <table>
                        <tr>
                            <td class="info-catatan2" style="font-size: 13px;">Kode Supplier</td>
                            <td class="info-item" style="font-size: 13px;">:</td>
                            <td class="info-text info-left" style="font-size: 13px;">
                                {{ $inquery->pembelian->supplier->kode_supplier }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="info-item" style="font-size: 13px;">:</td>
                            <td class="info-text info-left" style="font-size: 13px;">
                                {{ $inquery->pembelian->supplier->nama_supp }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="info-item" style="font-size: 13px;">:</td>
                            <td class="info-text info-left" style="font-size: 13px;">
                                {{ $inquery->pembelian->supplier->telp }}
                            </td>
                        </tr>
                        <tr>
...
<div class="container">
    <a href="{{ url('admin/inquery_fakturpajakpembelian') }}" class="blue-button">Kembali</a>
    <a href="{{ url('admin/faktur_pajakpembelian/cetak-pdf/' . $inquery->id) }}" class="blue-button">Cetak</a>
</div>
