...
@section('title', 'Inquery Faktur Pajak Pembelian')
...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Faktur Pajak Pembelian</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/faktur_pajak') }}">Inquery Faktur Pajak
                                Pembelian</a></li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/inquery_fakturpajakpembelian', $inquery->id) }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('kategori') is-invalid @enderror"
                                id="kategori" name="kategori" value="{{ old('kategori', $inquery->kategori) }}" readonly
                                placeholder="">
                        </div>
                        <div class="mb-3 mt-4">
                            <button class="btn btn-primary btn-sm" type="button" onclick="showPenjualan(this.value)">
                                <i class="fas fa-plus mr-2"></i> Pilih Pembelian
                            </button>
                        </div>
                        <div class="form-group" hidden>
                            <label for="nopol">Id Pembelian</label>
                            <input type="text" class="form-control  @error('pembelian_id') is-invalid @enderror"
                                id="pembelian_id" name="pembelian_id"
                                value="{{ old('pembelian_id', $inquery->pembelian_id) }}" readonly placeholder="">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('kode_pembelian') is-invalid @enderror"
                                ...
                                value="{{ old('kode_pembelian', $inquery->pembelian->kode_pembelian) }}">
                        </div>
                        <div class="form-group">
                            <label>Kode Supplier</label>
                            <input class="form-control @error('kode_supplier') is-invalid @enderror" id="kode_supplier"
                                name="kode_supplier" type="text" placeholder=""
                                value="{{ old('kode_supplier', $inquery->pembelian->supplier->kode_supplier) }}" readonly />
                        </div>
                        <div class="form-group">
                            <label>Nama Supplier</label>
                            <input class="form-control @error('nama_supp') is-invalid @enderror" id="nama_supp"
                                name="nama_supp" type="text" placeholder=""
                                value="{{ old('nama_supp', $inquery->pembelian->supplier->nama_supp) }}" readonly />
                        </div>
                        <div class="form-group">
                            <label for="nama">Telp</label>
                            <input type="text" class="form-control @error('telp') is-invalid @enderror" id="telp"
                                name="telp" readonly placeholder=""
                                value="{{ old('telp', $inquery->pembelian->supplier->telp) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('harga') is-invalid @enderror" readonly
                                ...
                                value="{{ old('harga', $inquery->pembelian->grand_total) }}">
                        </div>
                        <div class="form-group mb-3">
                            ...
                            @else
                                <img class="mt-3" src="{{ asset('storage/uploads/' . $inquery->gambar_pajak) }}"
                                    alt="tigerload" height="180" width="200">
                            @endif
                        </div>
                        <div class="form-group">
        ...
        $(document).ready(function() {
            ...
            $('#kategori').on('change', function() {
                ...
                switch (selectedValue) {
                    case 'pembelian':
                        window.location.href = "{{ url('admin/inquery_fakturpajakpembelian/create') }}";
                        break;
                    case 'penjualan':
