                                    ...
                                    <td class="text-center">
                                        @if ($penjualan->status == 'unpost')
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#modal-hapus-{{ $penjualan->id }}">
                                                <i class="fas fa-times"></i>
                                            </button>
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                                data-target="#modal-posting-{{ $penjualan->id }}">
                                        ...
                                        @if ($penjualan->status == 'posting')
                                            ...
                                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                                                data-target="#modal-unpost-{{ $penjualan->id }}">
                                                <i class="fas fa-check"></i>
                                            </button>
                                        @endif
                                    </td>
                                ...
                                <div class="modal fade" id="modal-hapus-{{ $penjualan->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Yakin hapus penjualan <strong>{{ $penjualan->kode_penjualan }}</strong>?
                                                </p>
                                            </div>
                                            <div class="modal-footer justify-content-between">
                                                <button type="button" class="btn btn-default"
