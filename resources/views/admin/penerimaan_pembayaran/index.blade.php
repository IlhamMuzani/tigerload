...
@section('title', 'Surat Penerimaan Pembayaran')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Surat Penerimaan Pembayaran</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Surat Penerimaan Pembayaran</h3>
                    <div class="float-right">
                        <a href="{{ url('admin/penerimaan_pembayaran/create') }}" class="btn btn-primary btn-sm">
