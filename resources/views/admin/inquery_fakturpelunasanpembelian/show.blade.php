...
<head>
    ...
    <title>Inquery Pelunasan Faktur Pembelian</title>
    <style>
        /* * {
...
<body style="margin: 0; padding: 0;">
    <table cellpadding="2" cellspacing="0">
        <tr>
            <td class="info-catatan2" style="font-size: 17px;">CV. TIGER LOAD ENGINEERING</td>
        ...
        <tr>
            <td class="info-text info-left" style="font-size: 17px;">Jl. Ahmad Yani No. 42 Procot Slawi,
            </td>
            </td>
        ...
        <tr>
            <td class="info-text info-left" style="font-size: 17px;">Tegal 52411
            </td>
        ...
        <tr>
            <td class="info-text info-left" style="font-size: 17px;">Telp, (0283) 4563746
            </td>
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="td" style="text-align: center; padding: 5px; font-size: 17px;">Faktur Pembelian</td>
        ...
        @foreach ($details as $item)
            <tr>
                ...
                <td class="td" style="text-align: center;  font-size: 17px;">{{ $item->kode_pembelian }}</td>
...
<div class="container">
    <a href="{{ url('admin/tablepelunasanpembelian') }}" class="blue-button">Kembali</a>
    <a href="{{ url('admin/faktur_pelunasanpembelian/cetak-pdf/' . $cetakpdf->id) }}" class="blue-button">Cetak</a>
</div>
