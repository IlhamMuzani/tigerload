            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <a href="{{ url('admin/perintah_kerja/create') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($surat->status == 'unpost')
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ url('admin/perintah_kerja/' . $surat->id) }}">Show</a>
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_perintahkerja/unpostpenerimaan/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('admin/inquery_perintahkerja/postingpenerimaan/') }}/" +
                        memoId,
                    type: 'GET',
                    data: {
                        id: memoId
