...
@section('title', 'Tambah Surat Perintah Kerja')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('admin/perintah_kerja') }}">Surat Perintah Kerja</a>
                        </li>
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/perintah_kerja') }}" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card">
                    <div></div>
                    <div class="card-body">
                        ...
                        <div hidden class="mb-3">
                            <label class="form-label" for="spk_id">Surat Pesanan Id</label>
                            <input class="form-control @error('spk_id') is-invalid @enderror" id="spk_id" name="spk_id"
