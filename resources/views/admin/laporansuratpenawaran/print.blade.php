...
<body>
    <div class="container">
        <h1>LAPORAN SURAT PENAWARAN - RANGKUMAN</h1>
    </div>
    ...
    <table>
        ...
        @foreach ($inquery as $spk)
            <tr>
                ...
                <td>
                    @if ($spk->detail_suratpenawaran->first())
                        {{ $spk->detail_suratpenawaran->first()->merek->nama_merek }}
                    @else
                        data tidak ada
                    @endif
                </td>
                <td>
                    @if ($spk->detail_suratpenawaran->first())
                        {{ $spk->detail_suratpenawaran->first()->merek->tipe->nama_tipe }}
                    @else
                        data tidak ada
                    @endif
                </td>
                ...
                {{-- <td>
                    @if ($spk->kendaraan->merek)
                        {{ $spk->kendaraan->merek->nama_merek }}
                    @else
                        data tidak ada
                    @endif
                </td> --}}
