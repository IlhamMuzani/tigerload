...
<body style="margin: 0; padding: 0;">
        ...
        <tr>
            ...
            <td style="width: 50%;">
                <div class="info-catatan" style="max-width: 230px;">
                    <table>
                        <tr>
                            <td class="info-catatan2" style="font-size: 11px;">CV. TIGER LOAD ENGINEERING</td>

                        </tr>
                        <tr>
                            <td class="info-text info-left" style="font-size: 11px;">Jl. Ahmad Yani No. 42,</td>

                        </tr>
                        <tr>
                            <td class="info-text info-left" style="font-size: 11px;">Procot Slawi, Tegal 52411</td>

                        </tr>
                        <tr>
                            <td class="info-text info-left" style="font-size: 11px;">Telp, (0283) 4563746
                            </td>
            ...
            <td style="width: 70%;" style="max-width: 230px;">
                <div class="info-catatan">
                    <table>
                        <tr>
                            <td class="info-catatan2" style="font-size: 11px;">Nama Pelanggan</td>
                            <td class="info-item" style="font-size: 11px;">:</td>
                            <td class="info-text info-left" style="font-size: 11px;">
                        ...
                        <tr>
                            <td class="info-catatan2" style="font-size: 11px;">Alamat</td>
                            <td class="info-item" style="font-size: 11px;">:</td>
                            <td class="info-text info-left" style="font-size: 11px;">
                                @if ($pelunasans->penjualan)
                        ...
                        <tr>
                            <td class="info-catatan2" style="font-size: 11px;">Telp</td>
                            <td class="info-item" style="font-size: 11px;">:</td>
                            <td class="info-text info-left" style="font-size: 11px;">
                                @if ($pelunasans->penjualan)
                        ...
                        <tr>
                            <td class="info-catatan2" style="font-size: 11px;">ID Pelanggan</td>
                            <td class="info-item" style="font-size: 11px;">:</td>
                            <td class="info-text info-left" style="font-size: 11px;">
                                @if ($pelunasans->penjualan)
    ...
    <table style="width: 100%; border-top: 1px solid black; margin-bottom:5px">
        <tr>
            <td>
                <span class="info-item" style="font-size: 11px; padding-left: 5px;">No. Faktur:
                    {{ $pelunasans->kode_pelunasan }}</span>
                <br>
            </td>
            <td style="text-align: right; padding-right: 45px;">
                <span class="info-item" style="font-size: 11px;">Tanggal:{{ $pelunasans->tanggal }}</span>
                <br>
            </td>
            <td style="text-align: right;">
                <span class="info-item" style="font-size: 11px;">Status: <span
    ...
    <table style="width: 100%; border-top: 1px solid black;" cellpadding="2" cellspacing="0">
        ...
        @endphp
        <tr>
            <td class="td" style="text-align: center;  font-size: 11px;">1
            </td>
        ...
        @foreach ($detail_penjualans as $item)
            <tr>
                <td class="td" style="text-align: center;  font-size: 11px;">{{ $startFrom }}
                </td>
                @php
                    $startFrom++;
                @endphp
    ...
    <table style="width: 100%; border-top: 1px solid black; margin-bottom:5px">
        <tr>
            <td>
                <span class="info-item" style="font-size: 11px; padding-left: 5px; font-weight:bold">RINCIAN
                    PEMBAYARAN</span>
                <br>
            </td>
            <td style="text-align: right;">
        ...
        <tr>
            ...
            <td style="width: 50%;">
                <div class="info-catatan" style="max-width: 230px;">
                    <table>
                        <tr>
                            <td class="info-catatan2" style="font-size: 11px; color:white">.</td>

                        </tr>
                        <tr>
                            <td class="info-text info-left" style="font-size: 11px; color:white">.</td>
                        ...
                        <tr>
                            <td class="info-text info-left" style="font-size: 11px; color:white">.
                            </td>
            ...
            <td style="width: 70%;" style="max-width: 230px;">
                <div class="info-catatan">
                    <table>
                        <tr>
                            <td class="" style="font-size: 11px;">Potongan Penjualan</td>
                            <td class="info-item" style="font-size: 11px;"></td>
                        ...
                        <tr>
                            <td class="" style="font-size: 11px;">Sisa Tagihan</td>
                            <td class="info-item" style="font-size: 11px;"></td>
                            <td class="info-text info-left" style="font-size: 11px;  text-align: right;">
                    ...
                    <table>
                        ...
                        @foreach ($depositpemesanans as $index => $deposit)
                            <tr>
                                <td class="" style="font-size: 11px;">DP
    ...
    @if ($pelunasans->penjualan)
        @if ($pelunasans->penjualan->perintah_kerja->spk->kategori == 'NON PPN')
            <table width="100%">
                <tr>
                    <td>
                        <div class="info-catatan" style="max-width: 400px; font-size: 11px;">
                            <table>
                                <tr>
                                    <td>Nama Bank</td>
                                    <td>:</td>
