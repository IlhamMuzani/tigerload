                                ...
                                @foreach ($details as $detail)
                                    <tr id="pembelian-{{ $loop->index }}">
                                        ...
                                        <td>
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="kode_barang-0"
                                                    name="kode_barang[]" readonly value="{{ $detail['kode_barang'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="nama_barang-0"
                                                    name="nama_barang[]" readonly value="{{ $detail['nama_barang'] }}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
