...
@section('content')
                        ...
                        <tbody class="list">
                            @foreach ($inquery as $faktur_pajak)
                                <tr class="dropdown"{{ $faktur_pajak->id }}>
                                    ...
                                    $total_price = $faktur_pajak->penjualan->perintah_kerja->spk->harga;
                                    $tax_rate = 0.11;
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('admin/inquery_fakturpajak') }}";
            form.submit();
        }
    </script>
    ...
    <script>
        ...
        function printSelectedDatafoto() {
            ...
            if (selectedIds.length === 0) {
                ...
                window.location.href = "{{ url('admin/cetak_buktifilterpenjualan') }}?ids=" + selectedIdsString;
