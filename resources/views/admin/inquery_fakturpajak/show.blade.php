...
<body style="margin: 0; padding: 0;">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="info-text info-left" style="font-size: 13px;">
                                {{ $inquery->penjualan->perintah_kerja->kode_perintah }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="info-item" style="font-size: 13px;">:</td>
                            <td class="info-text info-left" style="font-size: 13px;">
                                {{ $inquery->penjualan->perintah_kerja->pelanggan->nama_pelanggan }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="info-item" style="font-size: 13px;">:</td>
                            <td class="info-text info-left" style="font-size: 13px;">
                                {{ $inquery->penjualan->perintah_kerja->typekaroseri->nama_karoseri }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="info-text info-left" style="font-size: 13px; color:white">
                                {{ $inquery->penjualan->perintah_kerja->typekaroseri->kode_type }}
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    <table style="font-size:13px" width="100%">
        <tr>
            <td>
                <span class="info-item">No. Faktur: {{ $inquery->kode_pajak }}</span>
                <br>
            </td>
            <td style="text-align: right;">
                {{-- <span class="info-item">Tanggal:{{ now()->format('d-m-Y') }}</span> --}}
                <span class="info-item">Tanggal:{{ $inquery->tanggal }}</span>
                <br>
            </td>
        </tr>
    </table>
    ...
    <div style="font-weight: bold; text-align: center;">
        <span style="font-weight: bold; font-size: 20px;">Foto Bukti Pajak</span>
        <br>
    </div>
    <table width="100%">
        <tr>
            <td style="width: 100%; text-align: center;">
                <div style="width: 100%;">
                    <img src="{{ asset('storage/uploads/' . $inquery->gambar_pajak) }}"
                        alt="{{ $inquery->gambar_pajak }}" style="width: 100%; height: auto; max-width: 100%;"
                        alt="Logo Tigerload">
                </div>
            </td>
        </tr>
...
<div class="container">
    <a href="{{ url('admin/inquery_fakturpajak') }}" class="blue-button">Kembali</a>
    <a href="{{ url('admin/faktur_pajak/cetak-pdf/' . $inquery->id) }}" class="blue-button">Cetak</a>
</div>
