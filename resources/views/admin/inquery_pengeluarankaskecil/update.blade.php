...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('admin/inquery_pengeluarankaskecil/' . $inquery->id) }}" method="POST"
                                ...
                                <tbody id="tabel-pembelian">
                                    @foreach ($details as $detail)
                                        <tr id="pembelian-{{ $loop->index }}">
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <textarea style="font-size:14px" type="text" class="form-control" id="keterangan-{{ $loop->index }}"
                                                        name="keterangan[]" placeholder="Masukan keterangan">{{ $detail['keterangan'] }}</textarea>
                                                </div>
                                            </td>
    ...
    <script>
        function updateGrandTotal() {
            ...
            $('#grand_total').val(formatRupiahs(grandTotal))
        }
        ...
        function itemPembelian(identifier, key, value = null) {
            ...
            // kode_akun 
            item_pembelian += '<td onclick="addAkun(' + key +
                ')">';
            item_pembelian += '<div class="form-group">'
