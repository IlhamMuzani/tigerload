...
<body style="margin-top: 10; padding: 0;">
    <div id="logo-container">
        <img src="{{ public_path('storage/uploads/gambar_logo/login2.png') }}" alt="Logo Tigerload" width="150"
            height="50">

    </div>
    <div style="text-align: center;">
        <span style="font-weight: bold; font-size: 17px;">SLIP GAJI CV. TIGER LOAD ENGINEERING</span>
    </div>
